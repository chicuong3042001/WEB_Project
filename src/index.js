...
function viewTopSale(inp) {
   switch (inp) {
      case 'ngay':
         listtopsale.innerHTML = '<ul class="product-list"><li class="products" ><img src="./img/s21-ultra.jpg" alt="product"><div class="products-content"><p class="price">29000000đ</p><p class="description">Samsung Galaxy s21 Ultra </p><button class="buy">Mua ngay</button></div></li></ul> '
         break;
      case 'thang':
         listtopsale.innerHTML = '<ul class="product-list"><li class="products" ><img src="./img/iphone-12-pro-max.jpg" alt="product"><div class="products-content"><p class="price">29900000đ</p><p class="description">Iphone 12 Pro Max</p><button class="buy">Mua ngay</button></div></li></ul> '
         break;
      case 'nam':
         listtopsale.innerHTML = '<ul class="product-list"><li class="products" ><img src="./img/asus-rog-phone-5g.jpg" alt="product"><div class="products-content"><p class="price">22900000đ</p><p class="description">Asus Rog Phone 5 5G</p><button class="buy">Mua ngay</button></div></li></ul> '
         break;
